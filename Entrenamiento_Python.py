...
#INICIO
print("Bienvenid@ a Tiendas D1!!!")
try:
    cantidad_productos=int(input("Cuantos productos deseas adquirir?\n"))
except:
    print("Error: Ingresa un valor numerico por favor...")
...
if cantidad_productos<0:
    ...
    while cantidad_productos<0:
        try:
            cantidad_productos=int(input("Error: Porfavor ingresa una cantidad mayor a cero....\n"))
        except:
    ...
    for i in range(cantidad_productos):
        ...
        if precio<0:
            ...
            while precio<0:
                precio=float(input("Ingresa un precio mayor a cero\n"))
        ...
        if cantidad_del_producto<=0:
            ...
            while cantidad_del_producto<=0:
                cantidad_del_producto=int(input(f"Error: Ingresa una cantidad positiva...\n"))
    ...
    if descuento=="si":
        ...
        while cantidad_descuento<0 or cantidad_del_producto>100:
            cantidad_descuento=float(input("Error: Porfavor ingresa una cantidad entre 0 y 100...\n"))
...
if descuento=="si":
    print(f"Porcentaje de Descuento: {cantidad_descuento}%")
    print(f"Total Final: {(precio_total*cantidad_descuento/100):.2f}")